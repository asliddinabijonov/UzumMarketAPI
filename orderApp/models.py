...
class Order(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE)
    status = models.CharField(max_length=50, choices=STATUS_CHOIESES, default='1')
    delivery_date = models.DateField()
    phone_number = models.CharField(max_length=13)
    address = models.CharField(max_length=500)
    totle_payment = models.FloatField(validators=[MinValueValidator(0)])
    payment_type = models.CharField(max_length=30, choices=PAYMENT_CHOICES, default='CASH')
